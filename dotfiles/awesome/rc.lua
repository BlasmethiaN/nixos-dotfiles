...
-- Using awful.tag.connect_for_each_screen to ensure signals are connected per screen
awful.screen.connect_for_each_screen(function(s)
    awful.tag.connect_signal("request::default_layouts", s, function()
